...
int quadrance(ivec4 a) { return sum(a*a); }
int quadrance(ivec3 a) { return sum(a*a); }
int quadrance(ivec2 a) { return sum(a*a); }

uint quadrance(uvec4 a) { return sum(a*a); }
uint quadrance(uvec3 a) { return sum(a*a); }
uint quadrance(uvec2 a) { return sum(a*a); }
